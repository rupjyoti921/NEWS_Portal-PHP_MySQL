...
<head>
    ...
    <title>RDJR NEWS | Post Location</title>
...
<body>
    ...
    <section class="blog_area single-post-area ">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                <br><h3 style="text-transform: capitalize;"><?php echo $row['PostLocation'];?></h3><hr>
