...
$sql=mysqli_query($conn,"SELECT AdminPassword FROM  tbladmin where AdminUserName='$adminid' || AdminEmailId='$adminid'");
...
if (password_verify($password, $dbpassword)) {
 ...
 $conn=mysqli_query($conn,"update tbladmin set AdminPassword='$newhashedpass', updationDate='$currentTime' where AdminUserName='$adminid'");
