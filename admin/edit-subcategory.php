...
?>
    ...
    <head>
        ...
        <title>RDJR NEWS | Edit Sub-Category</title>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form class="form-horizontal" action=" " name="category" method="post">
