...
if (!isset($_SESSION['login'])) {
    ...
    // code for updation of data into the table    
...
?>
    ...
    <head>
        ...
        <title>RDJR NEWS | Edit Category</title>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    <?php
                                    $catid = intval($_GET['cid']);
                                    $query = mysqli_query($conn, "Select id,CategoryName,Description from  tblcategory where Is_Active=1 and id='$catid'");
                                    $cnt = 1;
