                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="manage-posts.php">Admin's Posts</a></li>
                                    <li><a href="admin-trash.php">Admin's Trashed Posts</a></li>
                                    <li><a href="pending-posts.php">Reporter's Pending Posts</a></li>
                                    <li><a href="approved-posts.php">Reporter's Approved Posts</a></li>
                                    <li><a href="trash-posts.php">Reporter's Trashed Posts</a></li>
                                </ul>
                            </li>
                            <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Reporter </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add_reporter.php">Add Reporter</a></li>
                                    <li><a href="manage_reporter.php">Manage Reporter</a></li>
                                    <li><a href="pending_reporter.php">Pending Reporter</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="users.php">Users Details</a></li>
                                </ul>
                            </li>
