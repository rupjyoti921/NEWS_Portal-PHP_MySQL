...
if(!isset($_SESSION['login'])){
    ...
    // code for updation of sub-admin
        if (isset($_POST['submit'])) {
        $aid = intval($_GET['said']);
        $email = $_POST['emailid'];
        $query = mysqli_query($conn, "Update  tbladmin set AdminEmailId='$email'  where userType=0 && id='$aid'");
        if ($query) {
...
?>
    ...
    <head>
        ...
        <title>RDJR NEWS | Edit Subadmin</title>
                            ...
                            <div class="col-sm-12">
                                <div class="card-box">
                                    ...
                                    ?>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <form class="form-horizontal" action=" " name="suadmin" method="post">
