...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>RDJR NEWS | Dashboard</title>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        ...
                                        <div class="wigdet-one-content">
                                            ...
                                            <?php $query = mysqli_query($conn, "select * from tblposts2 where Is_Active=1 or Is_Active=3");
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        ...
                                        <div class="wigdet-one-content">
                                            ...
                                            <?php $query = mysqli_query($conn, "select * from tblposts2 where Is_Active=0");
                                            $countposts = mysqli_num_rows($query);
                                            ?>
                                            <h2><?php echo htmlentities($countposts); ?> <small></small></h2>
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        ...
                                        <div class="wigdet-one-content">
                                            ...
                                            <?php $query = mysqli_query($conn, "select * from tblposts2 where Is_Active=2 or Is_Active=5");
                                            $countposts = mysqli_num_rows($query);
                                            ?>
                                            <h2><?php echo htmlentities($countposts); ?> <small></small></h2>
                            ...
                            <a href="trash-posts.php">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
                                            <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">No of Approved Reporter(s)</p>
                                            <?php $query = mysqli_query($conn, "select * from tblreporter where rep_status=1");
                                            $countposts = mysqli_num_rows($query);
                                            ?>
                                            <h2><?php echo htmlentities($countposts); ?> <small></small></h2>
                            ...
                            <a href="trash-posts.php">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
                                            <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">No of Pending Reporter(s)</p>
                                            <?php $query = mysqli_query($conn, "select * from tblreporter where rep_status=0");
                                            $countposts = mysqli_num_rows($query);
                                            ?>
                                            <h2><?php echo htmlentities($countposts); ?> <small></small></h2>
                            ...
                            <a href="trash-posts.php">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
                                            <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">No of User(s)</p>
                            ...
                            <a href="trash-posts.php">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
                                            <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">No of Approved Comment(s)</p>
                                            <?php $query = mysqli_query($conn, "select * from tblcomments where status='1'");
                                            $countposts = mysqli_num_rows($query);
                                            ?>
                                            <h2><?php echo htmlentities($countposts); ?> <small></small></h2>
