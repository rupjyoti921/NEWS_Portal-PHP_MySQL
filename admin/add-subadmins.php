...
if (!isset($_SESSION['login'])) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $usertype = '0';
        $query = mysqli_query($conn, "insert into tbladmin(AdminUserName,AdminEmailId,AdminPassword,userType ) values('$username','$email','$password','$usertype')");
        if ($query) {
...
?>
    ...
    <head>
        ...
        <title>RDJR NEWS | Add Subadmin</title>
        ...
        <!-- check for username is alredy exists or not  -->
        <script>
