...
$query = mysqli_query($conn, "select PageTitle, Description from tblpages where PageName='aboutus'");
...
<head>
    ...
    <title>RDJR NEWS | About us</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 posts-list">
                    <br><h4> <?php echo $row['PageTitle'] ;?> </h4><hr>
