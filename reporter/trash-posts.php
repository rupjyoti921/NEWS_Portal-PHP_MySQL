...
?>
    ...
    <head>
        ...
        <!-- App title -->
        <title>RDJR NEWS | Trash Posts</title>
                                                    ...
                                                    ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> <?php 
                                                                ...
                                                                if($status=='4'){ ?>
                                                                <button class="btn btn-success disabled" data-toggle="tooltip" data-placement="bottom" title="Deleted by Admin (Can't Restore)">Restore</button>
                                                                <?php }else{ ?>
                                                                <a href="trash-posts.php?pid=<?php echo htmlentities($row['postid']); ?>&&action=restore" onclick="return confirm('Do you really want to restore ?')"> <button class="btn btn-success">Restore</button></a>
                                                                <?php  } ?>
                                                                &nbsp;
                                                                <a href="trash-posts.php?presid=<?php echo htmlentities($row['postid']); ?>&&action=perdel" onclick="return confirm('Do you really want to delete ?')" style="color:red" ;><button class="btn btn-danger">Permanently Delete</button></a>
                                                            </td>
                                                        </tr>
                                                <?php }
                                                        } ?>
