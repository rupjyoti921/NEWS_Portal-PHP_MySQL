...
$query=mysqli_query($conn,"update tblposts2 set PostImage='$imgnewfile' where id='$postid'");
if($query)
{
...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($conn,"select PostImage,PostTitle from tblposts2 where id='$postid' and Is_Active=0 ");
