                                ...
                                <div class="p-6">
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                            <td><?php if ($status == 0) { ?><p style="color:blue" ;>Pending</p><?php } else if ($status == 1 || $status == 3) { ?><p style="color:green" ;>Approved</p><?php } else if($status==4){ ?><p style="color:red" ;>In Trash (Trashed by Admin)</p><?php } else { ?><p style="color:red" ;>In Trash (Trashedby me)</p><?php } ?></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <h4>Post Title : </h4>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="../admin/postimages/<?php echo htmlentities($row['PostImage']); ?>" width="400px" />
                                                ...
                                                ?>
                                                        ...
                                                        <img src="../admin/postimages/<?php echo htmlentities($row3['post_images']); ?>" width="400px" />
                                                <?php
                                                    }
                                                }
                                                ?>
